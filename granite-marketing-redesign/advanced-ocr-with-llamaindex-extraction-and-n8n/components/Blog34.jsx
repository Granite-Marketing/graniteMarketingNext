      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-2 md:gap-y-16 lg:grid-cols-3">
          <div className="flex size-full flex-col items-start justify-start text-start">
            ...
            <a className="mb-2 flex justify-start text-start" href="#">
              <h2 className="text-xl font-bold md:text-2xl">
                PDF parsing with AI and n8n
              </h2>
            </a>
            <p>Master structured data extraction from unstructured documents</p>
            <Button
              title="Read more"
              variant="link"
              size="link"
          ...
          <div className="flex size-full flex-col items-start justify-start text-start">
            ...
            <a className="mb-2 flex justify-start text-start" href="#">
              <h2 className="text-xl font-bold md:text-2xl">
                Connecting APIs without writing code
              </h2>
            </a>
            <p>Build integrations that sync data across your entire stack</p>
            <Button
              title="Read more"
              variant="link"
              size="link"
          ...
          <div className="flex size-full flex-col items-start justify-start text-start">
            ...
            <a className="mb-2 flex justify-start text-start" href="#">
              <h2 className="text-xl font-bold md:text-2xl">
                Reducing manual work through intelligent systems
              </h2>
            </a>
            <p>Free your team from repetitive tasks and focus on strategy</p>
            <Button
              title="Read more"
              variant="link"
              size="link"
