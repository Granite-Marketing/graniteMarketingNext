...
export function Hero() {
	return (
		<section
			id="hero"
			className="relative min-h-[85vh] flex items-center justify-center pt-16 pb-8 md:px-8 bg-background border-b border-border/40 overflow-hidden"
		>
			...
			<div className="container mx-auto md:px-4 z-10 relative">
				<div className="max-w-4xl mx-auto text-center border border-border/30 rounded-3xl p-6 md:p-16 my-8 backdrop-blur-xl bg-background/50 shadow-2xl shadow-primary/5">
					...
					<p className="text-lg md:text-xl mb-10 text-muted-foreground leading-relaxed max-w-3xl mx-auto text-pretty">
						Build custom automations that work the way you do. No code required,
