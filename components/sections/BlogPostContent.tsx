...
export function BlogPostContent({
  ...
  const defaultTags = ["OCR automation", "Document extraction", "N8n workflows", "Data processing"];
      ...
      <div className="container">
        <article className="mx-auto max-w-lg">
          <div className="mb-14 flex flex-col gap-y-8 sm:flex-row sm:items-center sm:justify-between md:mb-16 md:gap-y-0">
            ...
            <nav className="flex items-start gap-2" aria-label="Share post">
              <button
          ...
          <div>
            <div className="mb-8 text-center md:mb-10 lg:mb-12">
              ...
              <nav className="mb-8 mt-3 flex items-start justify-center gap-2 sm:mb-0 md:mt-4" aria-label="Share post">
                <button
                  onClick={() => navigator.clipboard.writeText(shareUrl)}
                  className="size-8 rounded-[1.25rem] bg-background-secondary p-1"
                  aria-label="Copy link"
          ...
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <div className="grow">
              <p className="font-semibold md:text-md">Granite Marketing</p>
              <p>AI automation specialists</p>
            </div>
          </div>
        </article>
      </div>
