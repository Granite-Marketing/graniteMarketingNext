		...
		<section className="relative overflow-hidden" aria-labelledby="cta-heading">
			<div className="px-6 padding-section-large">
				<div className="container  text-center relative z-10">
					...
					<p className="text-size-medium text-brand-off-white mb-8 max-w-2xl mx-auto">
						Stop wasting time on repetitive tasks. Let us build custom
						automations that free up your team to focus on what really matters.
					</p>
			...
			<div className="absolute inset-0 pointer-events-none" aria-hidden="true">
				<div
					...
					style={{
						background:
							"radial-gradient(circle, rgba(37, 153, 91, 0.4) 0%, transparent 70%)",
					}}
				/>
			</div>
		</section>
