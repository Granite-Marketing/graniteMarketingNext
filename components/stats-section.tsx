    ...
    <section id="results" className="py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-medium mb-6 text-balance">Built and proven across industries</h2>
          <div className="flex justify-between items-start">
            <p className="text-lg text-muted-foreground max-w-2xl leading-relaxed">
              We've delivered automations that stick. Real workflows for real teams. The numbers speak to what happens
              when you build something that actually solves the problem.
            </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-fr">
          ...
          <Card className="p-8 bg-card border-border hover:shadow-lg transition-shadow md:row-span-2">
            <div className="h-full flex flex-col">
              ...
              <div className="mt-auto">
                <h3 className="text-xl font-semibold mb-2">Automations deployed</h3>
          ...
          <Card className="overflow-hidden bg-muted border-border">
            <div className="h-full min-h-[200px]">
              <img src="/automation-dashboard.png" alt="Automation metrics" className="w-full h-full object-cover" />
            </div>
          </Card>
          ...
          <Card className="p-8 bg-card border-border hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-2">Customer satisfaction rate</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <Card className="p-8 bg-card border-border hover:shadow-lg transition-shadow">
            ...
            <p className="text-muted-foreground leading-relaxed">From websites to automations, we've delivered.</p>
          </Card>

          {/* Image card 2 */}
          <Card className="overflow-hidden bg-muted border-border">
            <div className="h-full min-h-[200px]">
              <img src="/workflow-automation.png" alt="Workflow visualization" className="w-full h-full object-cover" />
            </div>
          </Card>
        </div>
      </div>
