...
const steps = [
  {
    number: "01",
    title: "Map it out",
    description: "We listen to how your team moves through each day and find where time gets lost.",
  },
  {
    number: "02",
    title: "Design it",
    description: "Our automations take shape in n8n, built to fit your exact workflow without forcing change.",
  },
  {
    number: "03",
    title: "Deploy it",
    description: "The workflow goes live. Your systems talk. The work that mattered gets done in minutes.",
  },
]
    ...
    <section id="process" className="py-24 bg-muted/10">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-medium mb-6 text-balance">How we build your automations</h2>
        </div>
                ...
                <TabsContent key={index} value={index.toString()} className="mt-0">
                  <div className="space-y-6">
                    <div className="border-l-2 border-foreground pl-6 py-2">
                      ...
                      <h3 className="text-2xl md:text-3xl font-medium mb-3">{step.title}</h3>
                ...
                {steps.map((step, index) => (
                  <button
                    ...
                    className={`block w-full text-left transition-all relative ${
                      activeTab === index.toString() ? "opacity-100" : "opacity-40"
                    }`}
                  >
                    <div className="pl-6 py-2 relative">
                      ...
                      <h4 className="text-xl md:text-2xl font-normal">{step.title}</h4>
                    </div>
                  </button>
                ))}
              </div>
