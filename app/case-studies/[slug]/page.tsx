...
export async function generateMetadata({
	params,
}: CaseStudyParams): Promise<Metadata> {
...
export default async function CaseStudyPage({ params }: CaseStudyParams) {
	...
	const caseStudySchema = getCaseStudySchema({
		...
		description:
			study.excerpt ||
			`${study.industry} automation case study for ${study.client}`,
		slug,
		client: study.client,
							...
							<div className="container">
								...
								<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
									<div>
										...
										{/* Title */}
										<h1 className="heading-style-h1 mt-2 mb-4">
											{study.title}
										</h1>
					...
					<section className="section-case-study-cta">
						<div className="px-6 padding-section-large">
							<div className="container  text-center">
								<h2 className="heading-style-h3 mb-4">Want similar results?</h2>
